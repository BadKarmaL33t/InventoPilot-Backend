...
import com.fsd.inventopilot.services.impl.RoleAllocationValidatorImpl;
...
@Constraint(validatedBy = RoleAllocationValidatorImpl.class) //  specifies the class that implements the actual validation logic for the custom constraint
