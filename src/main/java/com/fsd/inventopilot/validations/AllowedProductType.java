...
import com.fsd.inventopilot.validations.impl.AllowedProductTypeImpl;
...
@Constraint(validatedBy = AllowedProductTypeImpl.class) //  specifies the class that implements the actual validation logic for the custom constraint
...
public @interface AllowedProductType {
    String message() default "Invalid value. Accepted values are RAW or SOLUBLE";
